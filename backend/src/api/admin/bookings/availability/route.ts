...
export const GetAdminBookingAvailabilitySchema = z.object({
  service_id: z.string(),
  date: z.string(),
  timezone: z.string().optional(),
})

export async function GET(req: MedusaRequest<z.infer<typeof GetAdminBookingAvailabilitySchema>>, res: MedusaResponse) {
